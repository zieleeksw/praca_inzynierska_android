...
import com.example.praca_inzynierska.view.models.post.FetchPostViewModel
...
fun HomeScreen(
    ...
    val homeViewModel = FetchPostViewModel()
    ...
    Scaffold(
        ...
        when {
            ...
            postState.value.error != null ->
                ...
                PostSectionComponent(navController, filteredPosts, it)
            }
        }
    }
}
